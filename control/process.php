...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        case 'setup':
            system('bash ' . BASE_PATH . '/setup.sh'); // Run in detached mode
            break;
        case 'continue':
            system('bash ' . BASE_PATH . '/continue.sh'); // Run in detached mode
            break;
        case 'reset':
            system('bash ' . BASE_PATH . '/reset.sh'); // Run in detached mode
            break;
        case 'stop':
            system("bash " . BASE_PATH . "/stop.sh"); // Execute stop.sh
            break;
        case 'save':
